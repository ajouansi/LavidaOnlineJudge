...
## pcre
wget -quiet ftp://ftp.csx.cam.ac.uk/pub/software/programming/pcre/pcre-8.35.tar.gz
cd ~/setup/src/
...
## apache2
wget -quiet http://mirror.apache-kr.org//httpd/httpd-2.4.9.tar.gz -O ~/setup/src/apache-2.4.9.tar.gz
cd ~/setup/src/
...
# clone lavida
git clone https://github.com/flrngel/LavidaOnlineJudge ~/web
